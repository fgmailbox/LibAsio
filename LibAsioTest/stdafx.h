...
/*
#define WM_UPDATE_DATA			WM_USER+1000
#define WM_NOFIFY_DATA			WM_USER+1001
#define WM_POST_InitialUpdate	WM_USER+1002
*/

//#define  _ListCtrlEx_

//class CServiceMonitorDoc;

//extern CServiceMonitorDoc * GetDocument();
